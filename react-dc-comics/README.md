...
Bonus: - Creare un componente aggiuntivo per gestire la fascia azzurra con le icone.Numero minimo di push: 10
...
Descrizione:
    ...
    1 - Create una nuova componente ListComics.jsx in cui importare tutti i fumetti
